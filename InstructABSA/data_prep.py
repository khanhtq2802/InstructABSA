...
class DatasetLoader:
    def __init__(
            self, 
            train_df_id : DataFrame = None, 
            test_df_id : DataFrame = None, 
            val_df_id : DataFrame = None, 
            train_df_ood : DataFrame = None, 
            test_df_ood : DataFrame = None, 
            val_df_ood : DataFrame = None, 
            sample_size : float = 1):
    ...
    def set_data_for_training_semeval(self, tokenize_function : Optional[Callable]):
        """
